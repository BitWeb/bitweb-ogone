 ...
 */
public class DirectLinkQueryResponseTest {

    @Test
    public void testConstructResponse() {

        try{
            DirectLinkQueryResponse response = new DirectLinkQueryResponse( getRequestXmlResponse() );
    ...
    public void testFilterRequestParameters() {
        try {
            ...
            Assert.assertEquals("CUSTOM_3", result.get("NCSTATUS") );
